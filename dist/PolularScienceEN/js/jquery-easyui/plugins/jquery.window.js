...
(function($) {
	...
	function _1f(_20) {
		...
		_21.window.draggable({
			...
			onStartDrag : function(e) {
				...
				if (!_21.proxy) {
					_21.proxy = $("<div class=\"window-proxy\"></div>")
							.insertAfter(_21.window);
				}
				_21.proxy.css({
					display : "none",
					zIndex : $.fn.window.defaults.zIndex++,
		...
		_21.window.resizable({
			disabled : _21.options.resizable == false,
			onStartResize : function(e) {
				_21.pmask = $("<div class=\"window-proxy-mask\"></div>")
						.insertAfter(_21.window);
				_21.pmask.css({
					zIndex : $.fn.window.defaults.zIndex++,
					left : e.data.left,
	...
	$.fn.window.parseOptions = function(_2a) {
		return $.extend({}, $.fn.panel.parseOptions(_2a), $.parser
				.parseOptions(_2a, [ {
					draggable : "boolean",
					resizable : "boolean",
					shadow : "boolean",
